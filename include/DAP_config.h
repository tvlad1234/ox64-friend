...
__STATIC_INLINE void PORT_JTAG_SETUP(void)
{
  ...
  sio_hw->gpio_oe_set = PROBE_PIN_TCK_SWCLK_MASK | PROBE_PIN_TMS_SWDIO_MASK | PROBE_PIN_TDI_MASK;
  sio_hw->gpio_set = PROBE_PIN_TCK_SWCLK_MASK | PROBE_PIN_TMS_SWDIO_MASK | PROBE_PIN_TDI_MASK;
...
__STATIC_INLINE void PORT_SWD_SETUP(void)
{
  ...
  /* input mode */
  sio_hw->gpio_oe_clr = PROBE_PIN_TDI_MASK | PROBE_PIN_TDO_MASK;
...
{
  sio_hw->gpio_oe_clr = PROBE_PIN_TCK_SWCLK_MASK | PROBE_PIN_TMS_SWDIO_MASK | PROBE_PIN_TDI_MASK | PROBE_PIN_TDO_MASK;
}
